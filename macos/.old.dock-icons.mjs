...
const PATH_ICONS = `/Desktop/Singularity/System/Assets/mac-icons`
...
void async function () {
	...
	iconDirectories = extractAppNames(iconDirectories)
	appDirectories = extractAppNames(appDirectories)
